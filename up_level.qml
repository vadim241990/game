        ...
        Rectangle
        {
            ...
            MouseArea
            {
                ...
                onHoveredChanged:
                {
                    ...
                    {
                        show_right();
                        opisanie_2_text.text = "Восполняет здоровье герою в объеме 30% от нанесенного урона по одной цели или 15% по множественным целям(герой маг)";
                    }
        ...
        Rectangle
        {
            ...
            MouseArea
            {
                ...
                onHoveredChanged:
                {
                    ...
                    {
                        show_right();
                        opisanie_2_text.text = "Раны кровоточят 2 следующих хода. Урон состовляет 20%(для героя мага 10%) от нанесенного урона. Эффект не суммируется и не обновляется после первого хода";
                    }
        ...
        Rectangle
        {
            ...
            MouseArea
            {
                ...
                onHoveredChanged:
                {
                    ...
                    {
                        show_right();
                        opisanie_2_text.text = "Увеличивает восполнение здоровья герою в объеме 50% от нанесенного урона по одной цели или 25% по множественным целям(герой маг)";
                    }
        ...
        Rectangle
        {
            ...
            MouseArea
            {
                ...
                onHoveredChanged:
                {
                    ...
                    {
                        show_right();
                        opisanie_2_text.text = "Раны кровоточят 2 следующих хода. Урон увеличивается до 40%(для героя мага 20%) от нанесенного урона. Эффект не суммируется и не обновляется после первого хода";
                    }
